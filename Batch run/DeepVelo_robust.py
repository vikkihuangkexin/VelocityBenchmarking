#!/usr/bin/env python3
"""
Multi-run DeepVelo analysis script for RNA velocity prediction.

Requirements:
- DeepVelo must be installed or available in PYTHONPATH
...
OUTPUT_DIR = os.getenv('OUTPUT_DIR', './example/output/DeepVelo')
...
def main_single(adata, save_dir, file_id, simulate=False):
    if simulate:
    ...
    for run_idx in range(1, n_runs + 1):
        ...
        for file_info in data_files:
            ...
            try:
                ...
                main_single(adata, save_dir, id_pre, simulate=simulate)

                print(f"  Saved: {id_pre}_deepvelo.h5ad")
