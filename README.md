...
- **`Simulation_generate/`**
Scripts for generating simulated single-cell datasets using [dyngen](https://github.com/dynverse/dyngen) across diverse trajectory backbone topologies, cell counts, and gene counts, transcriptional bursting simulations using [scMultiSim](https://github.com/ZhangLabGT/scMultiSim) . Lineage tracing simulation datsets were generated by using [scReadSim](https://github.com/JSB-UCLA/scReadSim).
